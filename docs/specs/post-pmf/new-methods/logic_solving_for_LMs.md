# Reliable Closed-form Logic Question Aswering API: based on autoformalization + LEAN
...
Used when: an LM needs a critical closed-form logical answer for a problem it has sufficient input data for (e.g., legal, financial, medical, hardware design, autonomous robotics)
